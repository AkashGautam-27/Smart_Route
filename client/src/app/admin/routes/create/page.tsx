...
import { FaRoute, FaArrowLeft, FaPlus, FaTrash, FaMapPin } from "react-icons/fa";
...
export default function CreateRoutePage() {
  ...
  if (loading) return <div className="p-8 text-center text-gray-500">Loading stops data...</div>;
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8">
          ...
          <div className="mt-10 pt-6 border-t border-gray-200 flex justify-end gap-4">
            ...
            <button
              ...
              className="px-6 py-2.5 bg-blue-600 border border-transparent rounded-lg text-sm font-medium text-white hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 transition-all shadow-sm"
            >
              {submitLoading ? "Creating Route..." : "Create Route"}
            </button>
          </div>
        </form>
      </div>
